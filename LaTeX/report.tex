...
tplayer@vols.utk.edu jmandzak@vols.utk.edu% email address must be in roman text type, not monospace or sans serif
}
 \begin{document}
...
\begin{tikzpicture}
 ...
 %      nodes near coords align=below, % places labels inside bars
        symbolic x coords={Male,Female, Old, Young, Disability},
        xtick = data,
        enlarge y limits={value=0.2,upper},
        legend pos=north west
    ]
		\addplot[fill=blue] coordinates {(Male, 1) (Female,1) (Old,1) (Young,1) (Disability, 1)};
    \end{axis}
\end{tikzpicture}
